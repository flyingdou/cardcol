...
<script>
	...
	function getProduct () {
		...
		$.ajax({
			url:"clubmp!findExpertProduct.asp",
			type:"post",
			dataType:"json",
			data:{
			...
			success: function (res) {
				...
				if (res.success) {
					res = res.goods;
					var strengthDate = vue.model.strengthDate;
					vue.model.product = {
						productId: 1,
					...
					wx.miniProgram.navigateTo({url: '../order/order?product=' + encodeURI(JSON.stringify(vue.model.product))});
				}
