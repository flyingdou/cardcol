...
<html lang="zh-CN">
  ...
  <body>
   <div style="width:100%; height:15px; background-color:#E7E7E7; "></div>
	<div>
	<s:iterator value="#request.member">
    	<div>
        	<div>
            	<img src="picture/<s:property value="member.image"/>" style="width:80px; height:80px; margin-left:10px; margin-top:20px;"/>
            </div>
            <div style="font-size:14px; color:#3c3c3c; margin-left:100px; margin-top:-80px;"><s:property value="member.name"/> ${a.creator.name}</div>
