...
<script type="text/javascript" src="ecartoon-weixin/js/jquery.Jcrop.js"></script>  
...
<script type="text/javascript">  
    ...
    function subform() {  
        ...
        if($("#imgfield").html()){  
            ...
            formData.append("image",dataURLtoBlob(data),"image.png");
            $.ajax({
 	    	   ...
 	    	   success: function (res){
 	    		   var dou = JSON.parse(res);
 	    		   sessionStorage.poster = JSON.stringify(dou.imageName);
                   history.go(-1);
 	    	   }
 	       });
        }else{
