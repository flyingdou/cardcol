...
public class OrderUtilC {
	...
	public static String orderSign(HttpServletRequest request, HttpServletResponse response, Order order, String type, String subject) throws Exception {
		if (type.equals("2")) {
			return PayUtilsC.alipayOrderSign(order, subject);
	...
	protected static String alipayOrderSign(Order order, String subject) throws Exception {
		...
		makeParms.append("notify_url=\"").append(URLEncoder.encode(AlipayConfig.notify_url_c)).append("\"&");
	...
	private static String weixinOrderSign(HttpServletRequest request, HttpServletResponse response, Order order) {
		...
		//String notify_url = "http://www.ecartoon.com.cn/cardcolv3/mwpaynotify.asp";
		// 2017-7-13  黄文俊  去掉 v3 作测试
//		 String notify_url = "http://www.ecartoon.com.cn/mwpaynotifyc.asp";
		 
		 //正式环境
//		 String notify_url = "http://www.ecartoon.com.cn:88/mwpaynotifyc.asp";
		 
		 String notify_url = "http://m45.cardcol.com/mwpaynotifyc.asp";
		// 内网微信支付
		//String notify_url = "http://1829840kl0.iask.in:88/cardcolv4/mwpaynotify.asp";
