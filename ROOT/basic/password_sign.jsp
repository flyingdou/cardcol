...
$(document).ready(function() {
	...
	$('input[type="button"]').click(function(){
		...
		$.ajax({url:'signpassword!save.asp',type:'post',data: params,
	...
	$('#password').blur(function(){
		...
		var val = $the.val();
		if (val == '') return;
		$.ajax({type: 'post',url: 'signpassword!check.asp',data: 'password=' + md5(val),
			success: function(msg) {
				if (msg != 'ok') {
	...
	<div id="content">
		...
		<div id="right-2">
			<div id="container">
				...
				<div>
					<div class="p_div"><p>原签到密码：<input type="password" name="text" id="password"/></p></div>
					<div class="p_div"><p>新签到密码：<input type="password" name="member.password" id="password1" /></p></div>
					<div class="p_div"><p>确认新密码：<input type="password" name="text" id="password2" /></p></div>
				</div>
				</s:form>
			</div>
