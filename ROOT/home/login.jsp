...
<meta name="keywords" content="健身E卡通-健身电子商务-服务平台" />
<meta name="description" content="健身E卡通-用户登录" />
<title>健身E卡通-用户登录</title>
...
<body>          
		...
		<div id="user">
			...
			<div id="user-right">
			    <div class="logdiv">
				    <div class="logdiv1"><b>登录ecartoon官网</b></div>
					<!--<div class="logdiv2">还不是卡库网用户？</div>-->
					<div class="logdiv3"></div>
				</div>
				
				<p>用户名: <input type="text" name="username" class="name-1 inputs" value="请输入手机号"
