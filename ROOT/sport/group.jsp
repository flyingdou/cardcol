...
<body>
	...
	<div class="weui-cells" style="margin-bottom: 65px" id="view">
		<ul class="mui-table-view ul2" style="margin: 2px;" id="productList">
			<!-- 课程列表开始 -->
			<li class="mui-table-view-cell mui-media" v-for="(group,index) in groups">
				<a href="javascript:void(0)">
					<img class="mui-media-object mui-pull-left user_img" :src="'picture/'+group.image" />
					<div class="mui-media-body">
						<div class="bt">{{group.name}}</div>
						<div class="bt">{{group.memo}}</div>
					</div>
				</a>
			</li>
			<!-- 课程列表结束 -->
	...
	<div class="footer" id="footer">
		<a href="http://www.ecartoon.com.cn/share45/share45.html?from=singlemessage&isappinstalled=1">
			下载APP,查看训练视频
		</a>
	</div>
	...
	<script type="text/javascript">
		var groups = ${pageInfo==null?0:pageInfo};
		var view = new Vue({
			el:"#view",
			data:{
				groups:groups.items
