Ext.calendar.DayView = Ext.extend(Ext.Container, {
    ...
    /**
     * @cfg {Object} parameter
     * The Object of query object. body view loading for querying
     */
    parameter: {},
    ...
    initComponent : function(){
        ...
        var header = Ext.applyIf({xtype: 'dayheaderview',id: this.id+'-hd'}, cfg);
        
        var body = Ext.applyIf({xtype: 'daybodyview', id: this.id+'-bd'}, cfg);
    ...
    setStartDate: function(dt){
    	this.header.setParameter(this.parameter);
    	this.header.setStartDate(dt, false);
        this.body.setParameter(this.parameter);
    ...
    moveNext : function(noRefresh){
        var dt = this.header.moveNext(noRefresh);
    ...
    movePrev : function(noRefresh){
        var dt = this.header.movePrev(noRefresh);
