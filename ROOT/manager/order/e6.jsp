   ...
   <div class="proedit" style="margin:0px auto">
	  <div class="profrist">
		...
		<div class="proedifour">
			...
			<p>
				1.甲方通过丙方购买乙方的<s:if test="product.cardType == \"1\""><s:textfield name="product.num1" cssClass="text2"/>月 时效卡</s:if>
				<s:else><s:textfield name="product.num2" cssClass="text2"/>次 计次卡</s:else>,有效期限<s:textfield name="product.wellNum" cssClass="text2"/>月。
			</p>
			<p>
				2.<span><s:if test="product.isReg == \"1\"">该会员资格记名，仅限甲方本人使用；甲方将会员资格转让他人时，<s:if test="product.assignCost!=null && product.assignCost!=''">需要</s:if><s:else>不需要</s:else>支付转让手续费 <s:textfield name="product.assignCost" cssClass="text2"/> 元。<br /></s:if> 
				 <s:else>该会员资格不记名，可由任何符合条件的持卡人使用。</s:else></span>
			</p>
			<p>
			...
			<p>
				14.丙方的服务系统仅对甲方的考勤进行监控。预付消费方式的风险由甲乙双方自行承担。甲乙双方在合同履行过程中产生的服务质量、安全责任事故、人身、财产损害事故或任何其它合同履行过程中产生的纠纷，丙方不承担任何包括但不限于补偿、赔偿、担保等法律责任。
			</p>
			<p>
