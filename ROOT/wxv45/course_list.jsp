...
<body ontouchstart>
	...
	<!--课程名称-->
	<div class="weui-cells" style="margin-bottom: 65px">
		<ul class="mui-table-view ul2" style="margin: 2px;" id="course_list">
			<!-- 课程列表开始 -->
			<li class="mui-table-view-cell mui-media" v-for="course in courses">
				<a v-bind:href="'mcoursewxv45!courseDetail.asp?flag=0&id='+ course.id">
					<%-- <img class="mui-media-object mui-pull-left user_img" v-bind:src="'${pageContext.request.contextPath}/picture/' + course.image" /> --%>
					<!-- Just for test -->
					<img class="mui-media-object mui-pull-left user_img" src="${pageContext.request.contextPath}/wxv45/images/jltx.png" />

					<div class="mui-media-body">
						<div class="bt">{{ course.course}}</div>
						<div class="bt">{{ course.coach.nick}}</div>
						<p class="time">{{ course.startTime }}-{{ course.endTime }}</p>
					</div>
				</a>
			</li>
			<!-- 课程列表结束 -->
	...
	<div class="footer">
		<a href="mcoursewxv45!courseDetail.asp?flag=1">预约课程</a>
	</div>
