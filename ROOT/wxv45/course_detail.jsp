		...
		<ul class="mui-table-view">
			<s:iterator value="pageInfo.items">
				...
				<li class="mui-table-view-cell">
					<a class="">
						课程名称
						<span class="mui-pull-right"><s:property value="courseInfo.name" /></span>
					</a>
				</li>
				<li class="mui-table-view-cell">
					<a class="">
						课程地点
						<span class="mui-pull-right"><s:property value="place" /></span>
					</a>
				</li>
				<li class="mui-table-view-cell">
					<a class="">
						课程时间
						<span class="mui-pull-right"><s:property value="planDate" /> <s:property value="startTime" />-<s:property value="endTime" /></span>
					</a>
				</li>
			</s:iterator>
		</ul>
