...
<script type="text/javascript">
	function onAdd(){
		...
		url="clublist!savePicture.asp?fileName="+pos+"&productId="+'<s:property value="#request.productId"/>';
		$('#frmimage').attr('action', url);
		$('#frmimage').submit();
	}
	
	function onReset() {
		url = "clublist!shoGo.asp?productId="+'<s:property value="#request.productId"/>';
		$('#frmimage').attr('action', url);
		$('#frmimage').submit();
	}
</script>
...
<s:form name="frmimage" theme="simple" id="frmimage" action="clublist!shopGo.asp" enctype="multipart/form-data">
