...
<body>
	...
	<div id="content">
		...
		<div id="right-2">
			...
			<div>
				<div class="div1">
					<a class="fabw" target="_blank">发博文</a>
				</div>
				<div class="div2">
					...
					<div id="blogrow">
						<ul class="fatbowen">
							<li class="first"><a href="sns!view.asp?id=<s:property value="id"/>"><s:property value="title"/></a></li>
							<li><s:date name="createTime" format="yyyy-MM-dd hh:mm:ss"/></li>
