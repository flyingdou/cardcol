		...
		<div class="mui-content">
			<div class="header-a">
				<div class="header-div">
					<img :src="'picture/'+plan.image1" class="header-img" />
					<div class="header-say ">
						<div class="header-smallimg ">
						  <div id="product-img-box" style="width:138.4px;height:78px;overflow: hidden;float: left;">
							 <img id="product-img" :src="'picture/'+plan.image1" width="100%" class="img-card" />
							</div>
							<div class="fleft ml-10">
								<div class="h33 font15" style="margin-top:2px;font-size:14px;">{{plan.name}}</div>
								<div class="h33 font13" style="margin-top:5px;font-size:12px;">发布人 : {{plan.memberName}}</div>
								<div class="h33 font13" style="margin-top:5px;font-size:12px;">下载数量 : {{plan.goodsCount}}次</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div style="margin-top: 10px;">
				<div class="content-bottombox" style="background-color: #FFF;">
					计划类型<span class="fright corange" id="moneyDou" style="color: #545556;">
						{{plan.planType | planType}}
					</span>
				</div>
				<div class="content-bottombox font15" style="background-color: #FFF;">
					适用对象<span id="fitStore" class="fright cgrey font13" style="color: #545556;">
						{{plan.applyObject | applyObject}}
					</span>
				</div>
				<div class="content-bottombox" style="background-color: #FFF;">
					适用场景<span class="fright corange" id="moneyDou" style="color: #545556;">
						{{plan.scene | scene}}
					</span>
				</div>
				<div class="content-bottombox font15" style="background-color: #FFF;">
					所需器材<span id="fitStore" class="fright cgrey font13" style="color: #545556;">
						{{plan.apparatuses}}
					</span>
				</div>
				<div class="content-bottombox" style="background-color: #FFF;">
					计划周期<span class="fright corange" id="moneyDou" style="color: #545556;">{{plan.plancircle}}天</span>
				</div>
				<div class="content-bottombox font15" style="background-color: #FFF;">
					价格<span id="fitStore" class="fright cgrey font13" style="color: #545556;">{{plan.price}}元</span>
				</div>
			</div>
			<div class="jtnr ">
				<div>
					<div class="font12" style="font-size: 14px;color: #545556;">
						计划简介
						<div style="padding: 10px;" v-html="plan.summary"></div>
					</div>
				</div>
			</div>
		</div>
...
<script>
	var vue = new Vue({
		...
		created: function(){
			var planId = location.search.split("=")[1];
			$.post("coachmp!loadPlan.asp",{
					id: planId,
					type: 3
				},function(res){
					vue.plan = JSON.parse(res)['item'];
			});
		},
		filters: {
	...
	function goBuy() {
		var param = {
				productId: vue.plan.id,
				productType: 'plan',
				image: vue.plan.image1,
				productName: vue.plan.name,
				productPrice: vue.plan.price,
				time: vue.time
		}
