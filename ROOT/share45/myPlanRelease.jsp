...
<body>
	<div data-role="page" class="pageCss">
		...
		<div data-role="main" class="ui-content main .ui-page-theme-f">
			<img src="${pageContext.request.contextPath}/share45/img/banner1.png"
				alt="" width="100%" />
			<ul data-role="listview" data-inset="true"
				class="listW noshadow noborder ">
				<li data-icon="false" class="noborder marginT10 ranzhiC"><span
					class="left qianka">燃脂</span> <span class="left timeshow">时间</span>
					<span class="right leng">循环次数</span>
					<div class="fix"></div></li>

				<li data-icon="false" class="noborder marginT10"><span
					class="left qianka"><s:property
							value="#request.map.sumTime/60*13" /><span class="ranzhiD">
							千卡</span></span> <span class="left timeshow"><s:property
							value="#request.map.sumTime/60" /><span class="ranzhiD">分钟</span></span>
					<span class="right leng">1</span>
					<div class="fix"></div></li>
				<li data-icon="false" class="noborder marginT10">
					<p class="h2Css1 left dzlist">动作列表</p>
					<p class="pCSS right Mact">
						<s:property value="#request.map.items.size" />
						个动作
					</p>
					<div class="fix"></div>
				</li>
				<s:iterator value="#request.map.items">
					<li data-icon="false" class="noborder borderpx"><a href="#"
						class="noborder"> <img
							src="<s:property value="action.image"/>"
							class="actionImg">
							<h2 class="h2Css">
		...
		<div data-role="footer" data-position="fixed" class="footerCss">
			<a href="javascript:downLoadAPP()" class="footerA"id="thisbtn">下载E卡通，获取健身方案</a>
		</div>
	</div>
