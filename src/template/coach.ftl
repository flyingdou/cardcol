...
<html lang="zh-CN">
  <head>
    ...
    <title>${c.courseInfo.name}-卡库健身</title>
  ...
  <div style="width:100%; height:20px; background-color:#EBEBEB;;"></div>
   <div style="margin-top:30px;margin-left:4%;">
        	<div>
				<img src="${c.coach.image}" class="img-circle" style="margin-top:-15px; width:80px; height:80px; margin-left:10px;">
            </div>
      		<div style="margin-left:120px; margin-top:-60px; color:#3c3c3c;">
        		<span><b>教 练 昵 称：${c.coach.name}</b></span><br>
