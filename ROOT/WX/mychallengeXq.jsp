...
<div class="challengeXp container">
    <div class="banner">
        <div class="bg_color">
            ...
            <div class="txt fl">
                <p>发布人：<span><s:property value="member.name" /></span></p>
                <p>裁判人：<span><s:if test="judgeMode == 'B' " ><s:property value="member.name"/></s:if>
						<s:else>报名者指定裁判</s:else></span></p>
    ...
    <div class="challenge_list">
        <div class="list_one">
                <div class="icon"><img src="images/D_icon_07.png"></div>
        ...
        <div class="list_one">
                <div class="icon"><img src="images/D_icon_10.png"></div>
                <p>成功奖励<span><s:property value="award" /></span></p>
        </div>
        <div class="list_one">
                <div class="icon"><img src="images/D_icon_12.png"></div>
                <p>失败惩罚<span>向<s:property value="institution.name" />捐款 <s:property value="amerceMoney" />元</span></p>
        </div>
    </div>
