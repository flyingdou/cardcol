     ...
     <div class="proedit" style="margin:0px auto">
	  <div class="profrist">
		...
		<div class="proedifour">
			...
			<p>4.	甲方应向乙方支付储值金额共计<s:textfield name="product.cost" cssClass="text2"/>元。双方同意将该合同款交付给丙方托管，并由丙方每月<input type="text" name="productReportDay" class="text1" value="系统自动计算" readonly="true" style="background: #f5f5f5;"/>号进行上一个月甲乙双方应付费用的结算。</p>
			...
			<p>7.	使用程序：甲方在乙方进行各项消费活动，结帐时由甲、乙双确认消费金额并通过丙方平台进行账号密码确认。</p>
			...
			<p>
				12.	乙方向甲方告知调整营业时间、暂停营业等重要事项，应当采用店堂告示及<span><s:checkboxlist name="product.talkFunc" cssClass="checkbox" list="#{'1':'交易平台短消息','2':'电子邮件','3':'短信','4':'传真'}" listKey="key" listValue="value"/></span>方式。
			</p>
			<p>
				13.	其它约定：<s:textarea name="product.remark" cols="80" rows="4" cssStyle="vertical-align:top; border:1px solid #CCC;"  maxlength="200"/>
			</p>
			<p>
				14.	双方均同意上述条款及《<a href="product!clause.asp" target="_blank">健身合同通用条款</a>》，三方通过本交易平台完成签约手续，甲方支付合同保证金后本合同正式生效。
			</p>
			<p>
