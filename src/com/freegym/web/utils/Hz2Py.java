...
public class Hz2Py {
	...
	private static final int[] AREA_CODE = new int[] { 45217, 45253, 45761, 46318, 46826, 47010, 47297, 47614, 48119, 48119, 49062, 49324, 49896, 50371, 50614,
			50622, 50906, 51387, 51446, 52218, 52698, 52698, 52698, 52980, 53689, 54481 };

	public static String getFirst(String text) {
		if (text == null || "".equals(text)) {
			return "";
		}
		return getAlpha(text.substring(0, 1));
	}
