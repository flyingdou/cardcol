	...
	<div class="content">
		...
		<div class="profile-all">
				...
				<div class="message-2">
					<div class="message-3">
						<span class="time">2010-08-10 14:08:55 <a href="#">[回复]</a>
							<a href="#">[删除]</a>
						</span><a href="#" id="message-4">你</a>&nbsp;对<a href="#" id="message-4">王教练</a>的<a
							href="#" id="message-4">健美操</a>课程的评价
					</div>
			...
			<div class="message">
				...
				<div class="message-2">
					<div class="message-3">
						<span class="time">2010-08-10 14:08:55 <a href="#">[删除]</a>
						</span><a href="#" id="message-4">你</a>&nbsp;对<a href="#" id="message-4">健美俱乐部</a>的评价
					</div>
					<div class="message-3">80分。欢迎参加ptstudio网络健身俱乐部。详细内容请浏览ptstudio网络健身平台首页</div>
				</div>
				<div class="clear"></div>
			</div>
			<div class="ye">
