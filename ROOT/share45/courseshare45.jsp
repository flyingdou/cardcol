...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/share45/css/demo3.css"/>
  <style type="text/css">
...
<div data-role="page"class="pageCss">
    ...
    <div data-role="main" class="ui-content main ">
            <ul data-role="listview" data-inset="true"class="listW noshadow noborder  uLH">
                ...
                <li  data-icon="false" class="noborder lishow">
                    <a href="#"class="noborder bg0">
                        <img src="picture/${map['image']}"class="BodybuildingCss"width="96" >
                        <h2 class="h2Css">${map['name']}</h2>
                        <p class="pCss">${map['clubName']}</p>
                    </a>
                </li>

                <li  data-icon="false" class="noborder padd5 lishow1" style="border-top:1px solid #ffffff!important; ">
                    <p class="h2Css1 left h2css2"><span class="spanCssIMG1A">地址： <span>${map['address']}</span></span></p>
        ...
        <div class="fix"></div>
        <ul data-role="listview" data-inset="true"class="listW noshadow noborder marginD csul" >
            <li  data-icon="false" class="noborder padd5B noborderCO">
                <p class="h2Css1 left"><span class="spanCssIMG">课程时间</span></p>
                <p class="pCSS right">${map['planDate']} ${map['startTime']}-${map['endTime']}</p>
                <div class="fix"></div>
            </li>
            <div class="underL"></div>
            <li  data-icon="false" class="noborder padd5B noborderCO">
                <p class="h2Css1 left"><span class="spanCssIMG1">剩余名额</span></p>
                <p class="pCSS right">${map['surplusNum']}人</p>
                <div class="fix"></div>
            </li>
            <div class="underL"style="padding: -1px 0 0 0!important;"></div>
            <li  data-icon="false" class="noborder padd5B noborderCO" >
                <p class="h2Css1 left "><span class="spanCssIMG2">
                    课程价格
                </span></p>
                <p class="pCSS right red1 ">￥ <span class="red3">${map['hour_price']}</span></p>

            </li>
            <div class="fix"></div>

            <li  data-icon="false" class="noborder  marginTop10 mt10">
                <p class="h2Css1">注意事项</p>
                <p class="pCSS2 ">${map['memo']}<p>
            </li>
        </ul>
    </div>
