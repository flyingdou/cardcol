    ...
    <div id="top-content">
        ...
        <p class="right">
         ...
         <a href="#"style="border:1px solid #666;padding:2px 5px">搜索俱乐部</a>		
			...
			<span>|</span><a href="message.asp" id="coloa" target="_parent">消息<b class="conrcont">(<b class="msgb">0</b>)</b></a>
<%-- 			<span>|</span><a href="shop!queryShopping.asp" id="coloa" target="_parent"><img src="images/gouwuche.png"/><b class="aimgb">购物车</b><b class="ainsp">0</b>件</a>
...
<div id="header">
	<div id="logo">
		<blockquote>
			<p>
				<a href="index.asp" target="_parent"><img src="images/logo.png" alt="E卡通网" /></a>
			</p>
		</blockquote>
	</div>
	<div id="switch">
        ...
        <div class="search">
                 <form id="search" name="search" action="" method="post">
                       <input type="button" value="" class="sousu" onclick="return doQuery();"> 
                    <s:select id="selectQueryType" class="sear_pic" name="queryType" list="#{'0':'健身俱乐部','1':'健身教练','2':'健身计划'}" listKey="key" listValue="value"/>
...
<!-- 		</div>  -->
	...
	<ul id="navitems">
		<li><a href="index.asp"<s:if test="#session.position == 0"> class="nav_a" </s:if>>首页</a></li>
		<li><a href="planlist.asp"<s:if test="#session.position == 4"> class="nav_a" </s:if>>健身计划</a></li>
		<li><a href="clublist.asp"<s:if test="#session.position == 2"> class="nav_a" </s:if>>健身场馆</a></li>
		<li><a href="coachlist.asp"<s:if test="#session.position == 3"> class="nav_a" </s:if>>健身教练</a></li>
		<li><a href="activelist.asp"<s:if test="#session.position == 1"> class="nav_a" </s:if>>健身挑战</a></li>
		<li><a href="map.asp"<s:if test="#session.position == 5"> class="hover"</s:if>>健身地图</a></li>
	</ul>
