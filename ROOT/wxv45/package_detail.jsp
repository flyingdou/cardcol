...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/eg/css/app.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/eg/css/mui.min.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/eg/css/mui.picker.min.css" />
<style>
.fright {
	float: right;
}
		...
		<s:iterator value="pageInfo.items">
			<footer class="mui-bar mui-bar-footer font-white"
				...
				<div class="font12" style="line-height: 44px;">
					...
					<a
						href="mmemberwxv45!buyPackage.asp?packageId=<s:property value='id' />"
						id='buy'>购买</a>
				</div>
			</footer>
			<div class="mui-content ">
						...
						<div class="header-say ">
							<div class="header-smallimg ">
								...
								<div class="fleft ml-10">
									<div class="h33 ">
										<span class="border-radiu8 font12"> 已售: <s:property
												value="count" />
										</span>
									</div>
									<div class="h33 font15 font7">
										<s:property value="name" />
									</div>
									<div class="h33 font13">
										有效期
										<s:property value="wellNum" />
										月
									</div>
								</div>
							</div>
							<div class="header-where">
								<div class="cishu">全市通用无限次数</div>
							</div>
						</div>
					</div>
				</div>
				<div style="margin-top: 10px;">
					<div class="content-bottombox jg">
						价格： <span class="fright corange font7 "> ￥ <s:property
								value="cost" /> 元
						</span>
					</div>
				</div>
...
<script
	src="${pageContext.request.contextPath }/eg/js/mui.picker.min.js "
