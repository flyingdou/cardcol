...
@Results({ @Result(name = "success", location = "/manager/basic/product_recommend.jsp") })
public class ProductRecommendManageAction extends SystemBasicAction {
	...
	protected void executeQuery() {
		...
		dc.add(Restrictions.eq("recommType", PRODUCT_TYPE_CARD));
