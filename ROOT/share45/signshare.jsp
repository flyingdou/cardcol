...
.wxtip-txt{margin-top: 107px; color: #fff; font-size: 16px; line-height: 1.5;}
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/share45/css/demo6.css"/>
    <title>签到详情</title>
</head>
<body>
...
<div data-role="page"class="pageCss ">
    <div data-role="header" data-position="fixed" class="headerCss"data-tap-toggle="false">
        ...
        <h1></h1>
        <a href="javascript:downLoadAPP()" class="ui-btn ui-corner-all ui-shadow  ui-btn-icon-left downLoadApp"id="thisbtn2">立即下载APP</a>
    </div>
    ...
    <div data-role="main" class="ui-content main " style="background-color: #f8f8f8!important;">
        ...
        <div class="fix"></div>
        <li class="doneL">
            <span class="done"><img src="${pageContext.request.contextPath}/share45/img/done.jpg" alt=""height="80px"/></span>

            <div class="qdC">
                <img src="${pageContext.request.contextPath}/share45/img/Fitnesstrip.png" alt=""width="200"/>
                <div class="num">${map['signDate']}</div>
            </div>
        </li>

        <li class="doneL1">
            <div class="map"id="container"></div>
            <div class="Iamhear ">我在这里，一起来健身吧!  ${map['image']}&nbsp;</div>
        </li>

    </div>

    <div data-role="footer" data-position="fixed"class="footerCss"data-tap-toggle="false">
        <a href="javascript:downLoadAPP()" class="footerA"id="thisbtn1"><span class="footerAspan"></span>下载E卡通</a>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var myLabel = new BMap.Label("<a style='color:white;text-decoration:none;' >${map['cname']}</a>",     //为lable填写内容
            {offset:new BMap.Size(-40,16),                  //label的偏移量，为了让label的中心显示在点上
...
weixinTip(btn1);
var btn2 = document.getElementById('thisbtn1');//下载一
weixinTip(btn2);
