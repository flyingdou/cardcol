...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
		     <meta name="keywords" content="健身E卡通-训练计划介绍" />
      <meta name="description" content="健身E卡通 -训练计划介绍" />
<title>${p.name}-健身E卡通 </title>
...
<div id="bg" class="">
 <div   class="zhezhao">   <!-- 遮罩开始 -->
    ...
    <div style="margin-left:170px; margin-top:-100px;">
        ...
        <div style="color:#CCC; margin-top:-15px;">作 者 : ${author}</div><br />
    </div>
    </div><!-- 遮罩结束部分 -->
</div>
...
<div>
    ...
    <div style="float:right; margin-right:3%; color:#999; margin-top:-20px; padding-right:20px;">${gtype}</div>
    <hr />
	<div style="padding-left:3%; margin-top:5%;">适用对象</div>
    <div style="float:right; margin-right:3%; color:#999; margin-top:-20px; padding-right:20px;">${gapply}</div>
    <hr />
    <div style="padding-left:3%; margin-top:5%;">适用场景</span>
    <div style="float:right; margin-right:3%; color:#999; padding-right:20px;">${gscene}</div>
    <hr />
    ...
    <div style="float:right; margin-right:3%; color:#999; margin-top:-20px; padding-right:20px;">${p.plancircle}</div>
    <hr />
	<div style=" margin-top:5%;">计划简介</div><br />
    <div style="height:60px; color:#999;">&nbsp;&nbsp;&nbsp;&nbsp;${p.summary}</div>
</div>
