...
<body>
	<form action="ecoursewx!saveMemberSetting.asp?id=${goodId}" method="post" id="form1" style="overflow:scroll;">
		<div class="mui-content" id="memberSetting">
			...
			<div class="w33_next">
				<div class="raioBox mui-input-row mui-radio" style="">
					<img src="ecartoon-weixin/img/buy/Reduced-fat-shape.png" width="42px" height="42px" />
				...
				<div class="raioBox mui-input-row mui-radio" style="">
					<img src="ecartoon-weixin/img/buy/Didnt-add-muscle.png" width="42px" height="42px" />
					<div class="label_box1">
				...
				<div class="raioBox mui-input-row mui-radio" style="">
					<img src="ecartoon-weixin/img/buy/strength.png" width="42px" height="42px" />
					<div class="label_box1">
			...
			<div class="w33_next">
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/spinning.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/basketball.png" class="checkboxImg" /> <label
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/badminton.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/football.png" class="checkboxImg" /> <label
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/run.png" class="checkboxImg" /> <label for=""
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/volleyball.png" class="checkboxImg" /> <label
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/swimming_1.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/Setting-up-exercise.png" class="checkboxImg" />
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/swimming.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/dancing.png" class="checkboxImg" /> <label
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/tennis.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/Mountain-climbing.png" class="checkboxImg" />
				...
				<div style="" class="form_nextbox">
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/Table-tennis.png" class="checkboxImg" /> <label
					...
					<div class="one">
						<div class="two mui-input-row mui-checkbox">
							<img src="ecartoon-weixin/img/buy/boxing.png" class="checkboxImg" /> <label
...
<script>
	...
	function checkedTest() {
		...
		if (count == 0) {
			...
			// 请求服务端,保存用户身体数据
			$.ajax({
				url:"ecoursewx!saveMemberSetting.asp",
				type:"post",
				data:{
				...
				success:function(res){
				  location.href = "eorderwx!saveProductType.asp?jsons="+encodeURI(JSON.stringify(res.jsons));
				}
			});
		}
	}
