...
@Results({ @Result(name = "success", location = "/manager/basic/plan_recommend.jsp") })
public class PlanRecommendManageAction extends SystemBasicAction {
	...
	protected void executeQuery() {
		...
		dc.add(Restrictions.eq("recommType", PRODUCT_TYPE_PLAN));
