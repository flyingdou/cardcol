...
<div id="divproductrecommend"></div>
...
Ext.onReady(function(){
	...
	Ext.create('Ext.ux.GridFormPanel', {
		...
		columns: [
			...
			{header:'原标题',dataIndex:'oldtitle',width:150},
		...
		bean: [
		   	{name:'id',type: 'long'},
			{name:'productId',type:'long',mapping:'product.id'},
			{name:'oldtitle',type:'string' ,mapping:'product.name'},
			{name:'title',type:'string' ,mapping:'title'},
			{name:'recommType', type: 'string'},
			{name:'color',type:'string'},
			{name:'icon1',type:'string' ,mapping:'product.image1'},
