...
Ext.onReady(function(){
	...
	Ext.create('Ext.ux.GridFormPanel', {
		...
		bean: [
		   	{name:'id',type: 'long'},
			{name:'productId',type:'long',mapping:'plan.id'},
			{name:'oldtitle',type:'string' ,mapping:'plan.planName'},
			{name:'title',type:'string' ,mapping:'title'},
			{name:'recommType', type: 'string'},	
			{name:'color',type:'string'},
			{name:'icon1',type:'string' ,mapping:'plan.image1'},
