...
<html>
	...
	<body>
		...
		<form action="registerwx!saveMember.asp" method="post" onsubmit="javascript:return login_1();">
		    ...
		    <div class="phone"style="">
		    	<div class="input_box">
		    	   <div class="div_left" >
		    	    ...
		    	    <div class="div_right">
		    		       <input type="number" id="phoneNumber" name="member.mobilephone" placeholder="请输入手机号码" value=""class="input_css" />
		    	    </div>
		    	   ...
		    	   <div class="div_left">
		    	    ...
		    	    <div class="hq_div">
		    	    	 <!-- <input id="getRegisterMobileCode" type="button"  class="span_hq" value="获取验证码"> -->
		    	   ...
		    	   <div class="div_left">
		    	    ...
		    	    <div class="div_right">
		    		       <input type="password" name="member.password" id="password" value=""placeholder="请输入密码"class="input_css" />
		    	    </div>
		    	                     <div style="clear: both;">	</div>
		    	</div>
	...
	<script type="text/javascript">
	    ...
	    function settime(val) {
	        if (countdown == 0) {
	        	$("#getRegisterMobileCode").attr('disabled', true);
	            val.innerText= "免费获取验证码";
	            countdown = 60;
	            clearTimeout(timeId);
	            return;
	        } else {
	        	$("#getRegisterMobileCode").attr('disabled', false);
	    ...
	    $("#getRegisterMobileCode").click(function(){
